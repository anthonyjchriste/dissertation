...
Other collections which are used by various Mauka plugins will described in their respective sections. 
...
This plugin takes advantage of Phenomena in order to find incidents that may not have passed Makai's triggering thresholds. As an example, the Phenomena for Topology Optimization uses two different techniques for optmizing the framework. 
...
\begin{figure}
	...
	\caption{OPQ View Screenshot}\label{fig:view_thresholds}
\end{figure}
