...
Detailed type information for metrics are included in tables \ref{table:Metrics}, \ref{table:MetricsPluginStat}, \ref{table:MetricsSystemStat}, and \ref{table:MetricsLaha}.
