...
The main page of Lokahi Web displays a map of currently active sensors (that the logged in user can access) and displays a list of those sensors sorted by distance from the users current location. This data is ontained by loading metadata from the database. An example if this interface is displayed in figure \ref{fig:lweb_main}.
