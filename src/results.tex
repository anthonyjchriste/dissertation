...
Simulated data provides upwards of 20 GB in data savings utilizing TTL compared to the actual AML data which does not utilize TTL. This provides evidence that a TTL approach could provide signficant data savings for the AML.
...
The total size of the Lokahi deployment reaches close to 3 TB over two and a half months. Next I will compare the total size of Laha to the estimated and simulated results from the Evaluation chapter.
