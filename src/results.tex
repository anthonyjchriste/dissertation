...
First I will examine the storage requirements at each level within the hierarchy. After these have been examined in detail, I will compare the actual results to the theoretical results founds in previous sections.
