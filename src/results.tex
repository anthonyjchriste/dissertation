...
\begin{figure}
    \begin{tabular}{cc}
        \subfloat{\includegraphics[width = 0.5\linewidth]{figures/f_hist_1000_POST_MAIN_2.png}} &
        \subfloat{\includegraphics[width = 0.5\linewidth]{figures/f_hist_1001_HAMILTON_LIB_PH_III_CH_1_MTR.png}} \\
        \subfloat{\includegraphics[width = 0.5\linewidth]{figures/f_hist_1001_HAMILTON_LIB_PH_III_CH_2_MTR.png}} &
        \subfloat{\includegraphics[width = 0.5\linewidth]{figures/f_hist_1001_HAMILTON_LIB_PH_III_CH_3_MTR.png}} \\
        \subfloat{\includegraphics[width = 0.5\linewidth]{figures/f_hist_1001_HAMILTON_LIB_PH_III_MCC_AC1_MTR.png}} &
        \subfloat{\includegraphics[width = 0.5\linewidth]{figures/f_hist_1001_HAMILTON_LIB_PH_III_MCC_AC2_MTR.png}} \\
    \end{tabular}
...
\begin{figure}
    \begin{tabular}{cc}
        \subfloat[1000 vs. POST\_MAIN\_1]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1000_POST_MAIN_1.png}} &
        \subfloat[1000 vs. POST\_MAIN\_2]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1000_POST_MAIN_2.png}} \\
        \subfloat[1002 vs. POST\_MAIN\_1]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1002_POST_MAIN_1.png}} &
        \subfloat[1002 vs. POST\_MAIN\_2]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1002_POST_MAIN_2.png}} \\
    \end{tabular}
...
\begin{figure}
    \begin{tabular}{cc}
        \subfloat[1001 vs. HAMILTON\_LIB\_PH\_III\_CH\_1\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1001_HAMILTON_LIB_PH_III_CH_1_MTR.png}} &
        \subfloat[1001 vs. HAMILTON\_LIB\_PH\_III\_CH\_2\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1001_HAMILTON_LIB_PH_III_CH_2_MTR.png}} \\
        \subfloat[1001 vs. HAMILTON\_LIB\_PH\_III\_CH\_3\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1001_HAMILTON_LIB_PH_III_CH_3_MTR.png}} \\
    \end{tabular}
...
\begin{figure}
    \begin{tabular}{cc}
        \subfloat[1001 vs. HAMILTON\_LIB\_PH\_III\_MAIN\_1\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1001_HAMILTON_LIB_PH_III_MAIN_1_MTR.png}} &
        \subfloat[1001 vs. HAMILTON\_LIB\_PH\_III\_MAIN\_2\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1001_HAMILTON_LIB_PH_III_MAIN_2_MTR.png}} \\
        \subfloat[1001 vs. HAMILTON\_LIB\_PH\_III\_MCC\_AC1\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1001_HAMILTON_LIB_PH_III_MCC_AC1_MTR.png}} &
        \subfloat[1001 vs. HAMILTON\_LIB\_PH\_III\_MCC\_AC2\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1001_HAMILTON_LIB_PH_III_MCC_AC2_MTR.png}} \\
    \end{tabular}
...
\begin{figure}
    \begin{tabular}{cc}
        \subfloat[1021 vs. MARINE\_SCIENCE\_MAIN\_A\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1021_MARINE_SCIENCE_MAIN_A_MTR.png}} &
        \subfloat[1021 vs. MARINE\_SCIENCE\_MAIN\_B\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1021_MARINE_SCIENCE_MAIN_B_MTR.png}} \\
        \subfloat[1021 vs. MARINE\_SCIENCE\_MCC\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1021_MARINE_SCIENCE_MCC_MTR.png}} &
        \subfloat[1022 vs. AG\_ENGINEERING\_MAIN\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1022_AG_ENGINEERING_MAIN_MTR.png}} \\
        \subfloat[1022 vs. AG\_ENGINEERING\_MCC\_MTR]{\includegraphics[width = 0.5\linewidth]{figures/thd_hist_1022_AG_ENGINEERING_MCC_MTR.png}} \\
    \end{tabular}
...
The OPQ ground truth data does not contain concepts that are related to Laha Incidents. Instead, I use apply thresholding to the ground truth data to determine where Incidents should have been observed verses when they were actually observed by Mauka. To complicate the matter, the OPQ ground truth data only provides features at a granularity of one minute. Therefore, I bin each invidvidual Incident by minute and only count the number of bins that contain Incidents.

Using thresholding breaks down for many of the Incident types that rely on the duration of a disturbance to apply a classification.
