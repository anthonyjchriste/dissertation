...
Figure shows the actual IL vs unbounded IL. The Incident Level contains metadata and data over window that contains classified signals of interest.
...
Now I will compare the results to the estimated (simulated) storage requirements with TTL.
