...
% TODO add figure
% TODO make figures applicable to OPQ and Lokahi
...
Since the parameters for sub-detections and detection windows can vary wildly, I next provide statistical approximations for computing upper and lower bounds on the DL\@.

\begin{align}
	\delta S_{SAMP} &= \frac{\sigma S_{SAMP}}{\sqrt{\mu SR * \mu T}} \\
	\delta \mu SR &= \frac{\sigma SR}{\sqrt{\mu SR * \mu T }} \\
	\delta \mu T &= \frac{\sigma T}{\sqrt{T}} \\
	\delta \mu B &= \frac{\sigma B}{\sqrt{B}} \\
	\mu S_{D} &= (\mu S_{SAMP} * \mu SR * \mu T * \mu B_{n}) + (S_{META} * \mu B_{n})
\end{align}
