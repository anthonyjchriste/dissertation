...
Chapter~\ref{ch:introduction} introduces the the problem statement, major components of the Laha abstract framework, traditional approaches to DSN optimization, contributions, and major claims. Chapter~\ref{ch:related-work} provides a literature review of related work. The Laha system design is outlined in Chapter~\ref{ch:system-design}. Evaluation of Laha is provided in Chapter~\ref{ch:evaluation} Finally, results and discussions of results are provided in Chapter~\ref{ch:results}.
