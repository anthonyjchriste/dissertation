...
\begin{table}[H]
	...
	\begin{tabular}{|c|p{6cm}|c|}
		...
		\hline
		message & oneof (Payload, Heartbeat, MakaiEvent, Measurement, MakaiTrigger, Laha, TriggerRequest, ThresholdOptimizationRequest, ) & A union of subtypes. \\
		\hline
	\end{tabular}
