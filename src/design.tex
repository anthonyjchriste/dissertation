...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{XlX}
		\toprule
		\textbf{Field} & \textbf{Enum} & \textbf{Value} & \textbf{Description} \\
		\midrule
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{XX}
        \toprule
        \textbf{Collection} & \textbf{Default} & \textbf{TTL} & \textbf{(seconds)} \\
        \midrule
        box\_samples & 900 \\
        measurements & 86400 \\
        trends & 604800 \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{llX}
		\toprule
		\textbf{Byte} & \textbf{Offset} & \textbf{Size} & \textbf{Description} \\
		\midrule
