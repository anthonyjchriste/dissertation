...
\begin{table}[H]
	...
	\begin{tabular}{|c|p{6cm}|c|}
		...
		\hline
		message & oneof (Payload, Heartbeat, MakaiEvent, Measurement, MakaiTrigger, Laha, TriggerRequest, ThresholdOptimizationRequest, RateOptimizaionRequest, TtlOptimization, Request) & A union of subtypes. \\
		\hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|p{8cm}|}
		...
		\hline
		trends\_hz & f32 & Trends per second \\
		\hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|p{8cm}|}
		...
		Field & Type & Description  \\
		\hline
		collection_name & str & Collection to modify the TTL for \\
		\hline
...
The ``RateOptimizationPlugin" is responsible for modifying the send rate of Measurements and Trends from specific Boxes. This plugin subscribes to ``RateOptimizationRequest" messages\ref{table:RateOptimizationRequest} which include a Box id and sample rates for the Measurements and Trends collections.
