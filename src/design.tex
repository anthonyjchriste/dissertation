...
A summary of data management in Laha is provided in Table~\ref{data-managament-table}.
...
The ``laha\_stats" collection contains system statistics that measure various performance metrics in relation to Laha's optimizations. The full details of the ``laha\_stats" collection are provided in the section describing the ``SystemStatsPlugin"~\ref{lbl:SystemStatsPlugin}.
